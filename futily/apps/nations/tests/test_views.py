...
class TestViews(TestCase):
    ...
    def test_nations_object_list(self):
        view = default_list_view(self)
...
def default_list_view(obj, paginate_by=NationListView.paginate_by, data={}):
...
def default_detail_view(obj, url='/england/', data={}):
    view = TestDetailView()
