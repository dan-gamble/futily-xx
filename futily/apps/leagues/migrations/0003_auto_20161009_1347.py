...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='league',
            name='browser_title',
            field=models.CharField(help_text="The heading to use in the user's web browser. Leave blank to use the page title. Search engines pay particular attention to this attribute.", max_length=1000, blank=True),
        ),
        migrations.AddField(
            model_name='league',
            name='is_online',
        ...
        migrations.AddField(
            ...
            field=models.TextField(help_text='A brief description of the contents of this page.', verbose_name='description', blank=True),
        ),
        migrations.AddField(
            model_name='league',
            name='og_description',
        ...
        migrations.AddField(
            model_name='league',
            name='page',
            field=models.ForeignKey(to='leagues.Leagues', null=True),
        ),
    ]
