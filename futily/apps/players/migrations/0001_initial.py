# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-07-24 21:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cached_url', models.CharField(blank=True, max_length=1000, null=True)),
                ...
                ('position', models.CharField(blank=True, choices=[(b'GK', b'GK'), (b'RWB', b'RWB'), (b'RB', b'RB'), (b'CB', b'CB'), (b'LB', b'LB'), (b'LWB', b'LWB'), (b'CDM', b'CDM'), (b'CM', b'CM'), (b'CAM', b'CAM'), (b'RM', b'RM'), (b'RW', b'RW'), (b'RF', b'RF'), (b'LM', b'LM'), (b'LW', b'LW'), (b'LF', b'LF'), (b'CF', b'CF'), (b'ST', b'ST')], max_length=3, null=True)),
                ('position_full', models.CharField(blank=True, max_length=100, null=True)),
                ('position_line', models.CharField(blank=True, choices=[(b'GK', b'Goalkeepers'), (b'DEF', b'Defenders'), (b'MID', b'Midfielders'), (b'ATT', b'Attackers')], max_length=3, null=True)),
                ...
                ('specialities', django.contrib.postgres.fields.jsonb.JSONField(null=True)),
                ...
                ('quality', models.CharField(blank=True, db_index=True, max_length=100, null=True)),
                ('color', models.CharField(blank=True, db_index=True, max_length=100, null=True)),
                ...
                ('league', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='league', to='leagues.League')),
                ('nation', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='nation', to='nations.Nation')),
            ],
            options={
