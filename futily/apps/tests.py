...
from .nations.models import Nation, Nations
from .players.models import Player
from .views import EaDetailView


class TestDetailView(EaDetailView):
    model = Nation
...
class TestViews(TestCase):  # pylint: disable=too-many-instance-attributes
    ...
    def test_ea_detail_view_player_pagination(self):
        # Player pagination
        view = default_detail_view(self, self.nation_pos)
    ...
    def test_ea_detail_view_filter_position(self):  # pylint: disable=too-many-locals, too-many-statements
        ...
        view_all = default_detail_view(self, self.nation_pos, data={'pos': 'all'})
        view_def = default_detail_view(self, self.nation_pos, data={'pos': 'def'})
        view_mid = default_detail_view(self, self.nation_pos, data={'pos': 'mid'})
        view_att = default_detail_view(self, self.nation_pos, data={'pos': 'att'})
        view_rbs = default_detail_view(self, self.nation_pos, data={'pos': 'rbs'})
        view_lbs = default_detail_view(self, self.nation_pos, data={'pos': 'lbs'})
        view_rms = default_detail_view(self, self.nation_pos, data={'pos': 'rms'})
        view_lms = default_detail_view(self, self.nation_pos, data={'pos': 'lms'})
        view_cms = default_detail_view(self, self.nation_pos, data={'pos': 'cms'})
        view_sts = default_detail_view(self, self.nation_pos, data={'pos': 'sts'})
        view_gk = default_detail_view(self, self.nation_pos, data={'pos': 'gk'})
        view_rwb = default_detail_view(self, self.nation_pos, data={'pos': 'rwb'})
        view_rb = default_detail_view(self, self.nation_pos, data={'pos': 'rb'})
        view_cb = default_detail_view(self, self.nation_pos, data={'pos': 'cb'})
        view_lb = default_detail_view(self, self.nation_pos, data={'pos': 'lb'})
        view_lwb = default_detail_view(self, self.nation_pos, data={'pos': 'lwb'})
        view_cdm = default_detail_view(self, self.nation_pos, data={'pos': 'cdm'})
        view_cm = default_detail_view(self, self.nation_pos, data={'pos': 'cm'})
        view_cam = default_detail_view(self, self.nation_pos, data={'pos': 'cam'})
        view_rm = default_detail_view(self, self.nation_pos, data={'pos': 'rm'})
        view_rw = default_detail_view(self, self.nation_pos, data={'pos': 'rw'})
        view_rf = default_detail_view(self, self.nation_pos, data={'pos': 'rf'})
        view_lm = default_detail_view(self, self.nation_pos, data={'pos': 'lm'})
        view_lw = default_detail_view(self, self.nation_pos, data={'pos': 'lw'})
        view_lf = default_detail_view(self, self.nation_pos, data={'pos': 'lf'})
        view_cf = default_detail_view(self, self.nation_pos, data={'pos': 'cf'})
        view_st = default_detail_view(self, self.nation_pos, data={'pos': 'st'})
    ...
    def test_ea_detail_view_filter_level(self):  # pylint: disable=too-many-locals, too-many-statements
        view_all = default_detail_view(self, self.nation_lvl, data={'lvl': 'all'})
        view_gold = default_detail_view(self, self.nation_lvl, data={'lvl': 'gold'})
        view_silver = default_detail_view(self, self.nation_lvl, data={'lvl': 'silver'})
        view_bronze = default_detail_view(self, self.nation_lvl, data={'lvl': 'bronze'})
        view_totw_all = default_detail_view(self, self.nation_lvl, data={'lvl': 'totw_all'})
        view_totw_gold = default_detail_view(self, self.nation_lvl, data={'lvl': 'totw_gold'})
        view_totw_silver = default_detail_view(self, self.nation_lvl, data={'lvl': 'totw_silver'})
        view_totw_bronze = default_detail_view(self, self.nation_lvl, data={'lvl': 'totw_bronze'})
        view_rare_all = default_detail_view(self, self.nation_lvl, data={'lvl': 'rare_all'})
        view_rare_gold = default_detail_view(self, self.nation_lvl, data={'lvl': 'rare_gold'})
        view_rare_silver = default_detail_view(self, self.nation_lvl, data={'lvl': 'rare_silver'})
        view_rare_bronze = default_detail_view(self, self.nation_lvl, data={'lvl': 'rare_bronze'})
        view_nonrare_all = default_detail_view(self, self.nation_lvl, data={'lvl': 'nonrare_all'})
        view_nonrare_gold = default_detail_view(self, self.nation_lvl, data={'lvl': 'nonrare_gold'})
        view_nonrare_silver = default_detail_view(self, self.nation_lvl, data={'lvl': 'nonrare_silver'})
        view_nonrare_bronze = default_detail_view(self, self.nation_lvl, data={'lvl': 'nonrare_bronze'})
        view_legends = default_detail_view(self, self.nation_lvl, data={'lvl': 'legend'})
    ...
    def test_ea_detail_view_sort_by(self):
        view_rating = default_detail_view(self, self.nation_pos, data={'sort': 'rating'})
        view_pace = default_detail_view(self, self.nation_pos, data={'sort': 'pace'})
        view_shooting = default_detail_view(self, self.nation_pos, data={'sort': 'shooting'})
        view_passing = default_detail_view(self, self.nation_pos, data={'sort': 'passing'})
        view_dribbling = default_detail_view(self, self.nation_pos, data={'sort': 'dribbling'})
        view_defending = default_detail_view(self, self.nation_pos, data={'sort': 'defending'})
        view_physical = default_detail_view(self, self.nation_pos, data={'sort': 'physical'})
...
def default_detail_view(obj, nation, url='/england/', data=None):  # pylint: disable=dangerous-default-value
    if data is None:
        data = {}
